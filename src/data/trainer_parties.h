static const struct TrainerMonNoItemDefaultMoves sParty_Hermie1[] = {
    {
    .iv = 0,
    .lvl = 3,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Lucy2[] = {
    {
    .iv = 0,
    .lvl = 5,
...
static const struct TrainerMonNoItemDefaultMoves sParty_Bennamin[] = {
    {
    .iv = 0,
    .lvl = 6,
